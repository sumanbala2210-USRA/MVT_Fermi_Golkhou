...
def compute_grb_time_bounds(T0, T90, end_t90=2.0):
    """
...
def mvtfermi(trigger_number=None, bw=None, T0=None,
    ...
    data_name = f"bn{config_dic['trigger_number']}_bw_{config_dic['bw']}_dets_{det_string}_en_{en}"
