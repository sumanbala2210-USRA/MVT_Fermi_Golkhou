...
**Place this `config_MVT.yaml` (`config_MVT_general.yaml` ) file in the directory from where you will run the `MVTfermi` (`MVTgeneral`) script or `mvtfermi` (`mvtgeneral()`) function . Update paths to reflect your local setup.**
